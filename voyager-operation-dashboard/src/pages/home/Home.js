...
function Home() {
    ...
    useEffect(() => {
        ...
        fetch(
            'http://localhost:8081/v0/fs/distribution/?metadata_distribution=genePanel',
            {
                headers: { Authorization: `Basic ${credentials}` },
            }
        )
        ...
        fetch(
            'http://localhost:8081/v0/run/api/?run_distribution=tags__sampleNameNormal',
            {
                headers: { Authorization: `Basic ${credentials}` },
            }
        )
        ...
        // Started runs
        fetch(
            'http://localhost:8081/v0/run/api/?status=RUNNING&values_run=name%2Cstarted&page_size=10000',
            {
                headers: { Authorization: `Basic ${credentials}` },
            }
        )
        ...
        fetch(
            'http://localhost:8081/v0/run/api/?values_run=name%2Cstarted&page_size=10000',
            {
                headers: { Authorization: `Basic ${credentials}` },
            }
        )
        ...
        fetch(
            'http://localhost:8081/v0/run/api/?status=FAILED&values_run=name%2Cfinished_date&page_size=10000',
            {
                headers: { Authorization: `Basic ${credentials}` },
            }
        )
